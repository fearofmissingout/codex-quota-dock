...
CGO_ENABLED=1 go build -buildvcs=false -trimpath -ldflags="-s -w -X github.com/fearofmissingout/codex-quota-dock/internal/version.Version=0.4.0-dev" -o codex-quota-dock ./cmd/codex-quota-dock
